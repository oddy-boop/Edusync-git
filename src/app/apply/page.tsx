            ...
            <form ref={formRef} action={formAction} className="space-y-8">
              <section className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {schoolsLoading ? (
                      ...
                      <Alert>
                        <AlertCircle className="h-4 w-4" />
                        <AlertDescription>
                          No school branches available at this time.
                        </AlertDescription>
                      </Alert>
                    ) : (
                ...
                <h3 className="text-xl font-semibold flex items-center gap-2 border-b pb-2">
                  <User className="text-primary" /> Student Information
                </h3>
                <div className="space-y-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <Church size={14} /> Student's Religion
                    </Label>
                    <Input
                      id="studentReligion"
                ...
                <div className="space-y-2">
                  <Label
                    ...
                    className="flex items-center gap-1"
                  >
                    <MapPin size={14} /> Student's Location/Address
                  </Label>
                  <Input
                    id="studentLocation"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="gradeLevelApplyingFor">
                      Grade/Class Applying For
                    </Label>
                    <Select name="gradeLevelApplyingFor" required>
                      <SelectTrigger id="gradeLevelApplyingFor">
                        <SelectValue placeholder="Select a class" />
                      </SelectTrigger>
                      <SelectContent>
                        {GRADE_LEVELS.filter((g) => g !== "Graduated").map(
                          (grade) => (
              ...
              <section className="space-y-4">
                <h3 className="text-xl font-semibold flex items-center gap-2 border-b pb-2">
                  <Shield className="text-primary" /> Guardian Information
                </h3>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label
                      htmlFor="guardianReligion"
                      className="flex items-center gap-1"
                    >
                      <Church size={14} /> Guardian's Religion
                    </Label>
                    <Input
                      id="guardianReligion"
                  ...
                  <div className="space-y-2">
                    <Label
                      ...
                      className="flex items-center gap-1"
                    >
                      <MapPin size={14} /> Guardian's Location/Address
                    </Label>
                    <Input
                      id="guardianLocation"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label
                      ...
                      className="flex items-center gap-1"
                    >
                      <Phone size={14} /> Guardian's Contact Number
                    </Label>
                    <Input
                      id="guardianContact"
                  ...
                  <div className="space-y-2">
                    <Label
                      ...
                      className="flex items-center gap-1"
                    >
                      <Mail size={14} /> Guardian's Email Address
                    </Label>
                    <Input
                      id="guardianEmail"
                      name="guardianEmail"
