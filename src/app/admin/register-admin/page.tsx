...
import { Loader2, UserCog, Info, School } from "lucide-react";
...
function SubmitButton() {
  ...
  return (
    <Button
      ...
      disabled={pending}
    >
      {pending ? <><Loader2 className="mr-2 h-4 w-4 animate-spin"/> Processing...</> : "Register & Invite Branch Admin"}
    </Button>
  );
}
      ...
      <Card className="shadow-lg max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle className="flex items-center text-2xl font-headline">
            <UserCog className="mr-2 h-6 w-6" /> Register New Branch Admin
          </CardTitle>
          <CardDescription>
