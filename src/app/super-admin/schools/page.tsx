    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all school branches on the platform.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          (window.location.href =
                            "/super-admin/register-branch-admin")
                        }
                      >
                        Register Admin →
                      </Button>
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center">
                      <Globe className="mr-2 h-4 w-4" /> Subdomain (Legacy -
                      Optional)
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        value={field.value ?? ""}
                        placeholder="e.g., adenta-campus"
                      />
                    </FormControl>
                    <FormDescription className="text-xs">
                      This is no longer used for login but can be kept for
                      reference. Use only letters, numbers, and hyphens.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <strong>{schoolToDelete.name}</strong> school branch and all
                associated data, including students, teachers, fees, and
                results.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
