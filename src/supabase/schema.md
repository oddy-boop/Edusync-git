...
DROP TABLE IF EXISTS public.app_settings; -- Now replaced by 'schools' table
...
CREATE TABLE public.schools (
    ...
    domain character varying(100) UNIQUE, -- e.g., 'sjs' for sjs.edusync.app
    address text,
...
-- Table: user_roles
-- Links authenticated users to their roles AND their school.
