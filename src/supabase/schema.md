...
DROP TABLE IF EXISTS public.schools; -- Dropped before app_settings if it existed
DROP TABLE IF EXISTS public.app_settings; -- Now fully replaced by 'schools' table
DROP TABLE IF EXISTS public.users;

-- ==================================================================
-- Section 1: Core Multi-Tenant and User Management Tables
-- ==================================================================

-- Table: schools (Replaces app_settings)
...
-- Table: users
-- A central table to manage logins for all roles, replacing auth.users.
...
-- Table: teachers
-- Stores teacher profile information, linked to a specific school.
...
-- Table: students
-- Stores student profile information, linked to a specific school.
...
CREATE TABLE public.attendance_records (
    ...
    status text NOT NULL,
    notes text,
    marked_by_teacher_auth_id uuid REFERENCES public.users(id) ON DELETE SET NULL,
...
CREATE TABLE public.staff_attendance (
    ...
    status text NOT NULL,
    notes text,
    marked_by_admin_id uuid REFERENCES public.users(id) ON DELETE SET NULL,
