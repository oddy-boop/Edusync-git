...
-- This version adds a UNIQUE constraint to user_roles.user_id.
-- ==================================================================
...
-- Table: app_settings
-- Stores global settings for the school instance.
CREATE TABLE public.app_settings (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    school_id uuid UNIQUE DEFAULT gen_random_uuid(),
...
CREATE TABLE public.user_roles (
    ...
    school_id uuid REFERENCES public.app_settings(school_id) ON DELETE CASCADE,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
